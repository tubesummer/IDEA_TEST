...
import com.nokia.utils.GenerateExcelFile;
...
public class ExtractGroupMembersToExcelFile {	
	...
	public static final String CDCADMIN = "cdcadmin";
	public static final String CDCADMIN_PWD = "asb#1234";
	
	public static final String JIRA_Prod = "https://greenhopper.app.alcatel-lucent.com";
	...
	public static void main(String[] args) throws IOException {		
		...
		List<JiraUser> allUsers = new ArrayList<JiraUser>();
